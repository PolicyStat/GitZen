...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GZUserProfile.user_type'
        db.delete_column('enhancement_tracking_gzuserprofile', 'user_type')

        # Adding field 'GZUserProfile.view_type'
        db.add_column('enhancement_tracking_gzuserprofile', 'view_type',
                      self.gf('django.db.models.fields.CharField')(default='ZEN', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GZUserProfile.user_type'
        db.add_column('enhancement_tracking_gzuserprofile', 'user_type',
                      self.gf('django.db.models.fields.CharField')(default='ZEN', max_length=3),
                      keep_default=False)

        # Deleting field 'GZUserProfile.view_type'
        db.delete_column('enhancement_tracking_gzuserprofile', 'view_type')
